    ...
    <div className="root">
      ...
      <style>{`
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .b1 { width:500px; height:500px; background: radial-gradient(#c8a96e,#7a5c2e); top:-120px; right:-80px; }
        .b2 { width:380px; height:380px; background: radial-gradient(#4a6fa5,#1a2a4a); bottom:-80px; left:-80px; animation-delay:-6s; }
        .grid {
